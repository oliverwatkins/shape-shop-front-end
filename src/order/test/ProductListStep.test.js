...
import {selectSelectedProductByType} from "../../selectors";
			...
			<Provider store={store}>
				<MemoryRouter>
					<ProductListStep
						...
						selectedDrinks={selectSelectedProductByType(data, "main")}
						selectedProducts={selectSelectedProductByType(data, "drinks")}/>
				</MemoryRouter>
			</Provider>
		);
	});
